...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative pt-16 pb-24 px-6 overflow-hidden bg-brand-cream">
      {/* Background Decor Butterflies (kept subtle, hidden on mobile to prevent overlapping text) */}
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 relative z-10">
        <div className="flex-1 text-center md:text-right">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-3 mb-8">
            <div className="inline-block bg-brand-green text-white px-6 py-2.5 rounded-full text-sm font-black tracking-widest uppercase shadow-lg border-b-4 border-brand-green/30">
              מעטפת לנשים באמצע החיים
            </div>
          ...
          {/* New Logo Position: Below the Title */}
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">
            <a 
              ...
              className="w-full sm:w-auto bg-brand-orange text-white hover:bg-brand-green px-12 py-5 rounded-full text-xl font-black shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2 border-b-4 border-brand-orange/30"
            >
